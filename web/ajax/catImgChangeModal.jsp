...
<div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <div class="modal-content container">
        ...
        <form method="POST" action="catImgChange" enctype="multipart/form-data">
            ...
            <textarea style="min-height: 130px !important;" id="descrizione" name="descrizione" class="form-control mb-4" required>${categoria.descrizione}</textarea>
            <label for="meta_descrizione">Meta Descrizione</label>
            <textarea maxlength="160" style="min-height: 100px;" id="meta_descrizione" name="meta_descrizione" class="form-control mb-4" placeholder="Meta Descrizione">${categoria.meta_descrizione}</textarea>
