<%-- 
    Document   : addConfezionato
    Created on : 10 set 2019, 15:08:04
    Author     : Roberto97
--%>
            ...
            <div class="modal-body">
                ...
                <div class="form-group form-inline" id="dynamic_form_conf">                                        
                    ...
                    <div class="button-group form-group col-lg-2 col-md-12">
                        <a href="javascript:void(0)" class="btn btn-primary" id="plus_conf" style="padding: .375rem .75rem;">+</a>
                        <a href="javascript:void(0)" class="btn btn-danger" id="minus_conf" style="padding: .375rem .75rem;">-</a>
                    </div>
                </div>
...
<script>
    ...
    $(document).ready(function () {
        var dynamic_form = $("#dynamic_form_conf").dynamicForm("#dynamic_form_conf", "#plus_conf", "#minus_conf", {
            limit: 10,
        ...
        $("#dynamic_form_conf #minus5").on('click', function () {
            var initDynamicId = $(this).closest('#dynamic_form_conf').parent().find("[id^='dynamic_form_conf']").length;
            if (initDynamicId === 2) {
                $(this).closest('#dynamic_form_conf').next().find('#minus_conf').hide();
            }
            $(this).closest('#dynamic_form_conf').remove();
        });
