 ...
 * @author Roberto97
 */
public class getPagesViews extends HttpServlet {
    ...
    public void init() throws ServletException {
        try {
            ...
            Logger.getLogger(getPagesViews.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String data = new Gson().toJson(consoledao.getPagesViews());
